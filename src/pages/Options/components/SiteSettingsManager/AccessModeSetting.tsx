...
export const accessModeTipText = (
  <>
    ...
    出现「"Poker Search" started debugging this browser」的横条。这个横条不应该去关闭，因为关闭了会导致移动端访问失效。<br />
    另外会对打开窗口的速度造成一定的减缓。这个横条可以消除，通过给浏览器增加 --silent-debugger-extension-api 的启动选项
  </>
)
